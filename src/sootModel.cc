...
//    coagulationMechanism    = coagulationMech::NONE;
    ...
    switch (psdMechanism) {
        case psdMech::MONO:  psd = new psdModel_MONO (*sourceTerms, nVar, N, G, X, C);
        case psdMech::LOGN:  psd = new psdModel_LOGN (*sourceTerms, nVar, N, G, X, C);
        case psdMech::QMOM:  psd = new psdModel_QMOM (*sourceTerms, nVar, N, G, X, C);
        case psdMech::MOMIC: psd = new psdModel_MOMIC(*sourceTerms, nVar, N, G, X, C);
