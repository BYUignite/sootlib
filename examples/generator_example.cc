...
int main(int argc, char** argv) {
    /*
     * There are 2 kinds of soot psdModels: bin and moment based
     ...
     * These can be set in the generator and then it will produce soot psdModels using those supporting psdModels
     */
    ...
    // new model is using these supporting psdModels
    rawMomentModel = momentModelGenerator.getModel();

    /*
     * There are different kinds of bin and moment soot psdModels
